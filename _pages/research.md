...
Autonomous driving, aka. mobile autonomy, promises to radically change the cityscape and save many human lives. A pillar component for achieving mobile autonomy is **spatial perception - the ability for vehicles to perceive the ambient environment and position themselves on the road**. Thanks to the recent advances in computer vision and solid-state technology, great improvements in spatial perception have been witnessed in a controlled environment. However, when it comes to the wild, such as bad weather, unfavourable illumination and massive dynamic objects, the robustness of many perception algorithms is still far from meeting the safety requirement of autonomous driving. We study the robust spatial perception problems in a holistic view, ranging from single-modality based methods to multi-sensory fusion, and to the perception uncertainty quantification. More recently, we are keen to unfold the potential of **4D automotive radar in localization and scene understanding**. As an emerging sensor, automotive radars are reputable for their sensing robustness against bad weather and adverse illumination. However, due to their significantly lower data quality, it remains largely unknown how one can transform the radar sensing robustness to vehicle perception effectiveness - real traction to many of my lab research focus. 
...
---
## **Robust and Efficient Spatial Awareness Support for First Responders**
